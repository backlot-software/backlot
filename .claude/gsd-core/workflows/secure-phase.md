...
```
Agent(
  prompt="Read /home/jeroen/Projects/Backlot/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/jeroen/Projects/Backlot/.claude/gsd-core/templates/SECURITY.md`
