...
- **Global scope**: `/home/jeroen/Projects/Backlot/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jeroen/Projects/Backlot/.claude/notes/`)
...
2. Glob `/home/jeroen/Projects/Backlot/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/jeroen/Projects/Backlot/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jeroen/Projects/Backlot/.claude/notes/` — works in any directory
