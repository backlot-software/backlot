...
- Usage: Reference from command with `@/home/jeroen/Projects/Backlot/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/jeroen/Projects/Backlot/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/jeroen/Projects/Backlot/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
