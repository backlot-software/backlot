...
<!-- For checkpoint task examples and patterns, see @/home/jeroen/Projects/Backlot/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/jeroen/Projects/Backlot/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/jeroen/Projects/Backlot/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/jeroen/Projects/Backlot/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
