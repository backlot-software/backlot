...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/jeroen/Projects/Backlot/.claude/.gsd-surface.json`
(sibling to `/home/jeroen/Projects/Backlot/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/jeroen/Projects/Backlot/.claude/skills/gsd-*/`.
...
(`/home/jeroen/Projects/Backlot/.claude`), NOT the skills sub-directory (`/home/jeroen/Projects/Backlot/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/home/jeroen/Projects/Backlot/.claude` as `configDir`. The skill dirs themselves live at
`/home/jeroen/Projects/Backlot/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/home/jeroen/Projects/Backlot/.claude}"
SCOPE="global"
...
(i.e. `/home/jeroen/Projects/Backlot/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/jeroen/Projects/Backlot/.claude/.gsd-surface.json`
Install profile marker: `/home/jeroen/Projects/Backlot/.claude/.gsd-profile`
Skill dirs: `/home/jeroen/Projects/Backlot/.claude/skills/gsd-*/`
Engine module: `/home/jeroen/Projects/Backlot/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/jeroen/Projects/Backlot/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
