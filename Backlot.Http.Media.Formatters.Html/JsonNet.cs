...
{
    //based on; https://github.com/StubbleOrg/Stubble.Extensions.JsonNet
    ...
    private static readonly Dictionary<Type, RendererSettingsDefaults.ValueGetterDelegate> ValueGetters = new Dictionary<Type, RendererSettingsDefaults.ValueGetterDelegate>
    {
        {
